...
quest-disassemble-umbrella-description = An old umbrella, broken beyond fixing, still has good parts in it — fabric, a metal pole, maybe more once you look closely. You've been picking apart everything the ruins give up lately, just to see how it was put together and what's worth keeping. Old technology has a way of hiding something useful inside, if you're willing to take it apart properly rather than leave it whole and useless. There's bound to be one buried somewhere out there.
