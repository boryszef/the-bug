...
quest-explore-ruins-description = Przejezdny podróżny wspomniał o pobliskich ruinach, podobno usianych starymi przedmiotami. Rzekomo na tych równinach znajdowało się niegdyś kilka wiosek - pozostałości wielkiej cywilizacji sprzed 500 lat — "Cywilizacji Cyfrowej", jak nazywają ją odkrywcy. Powinieneś zobaczyć to na własne oczy.
quest-old-civilization-name = Co kryją ruiny
quest-old-civilization-description = Ruiny sięgają głębiej, niż się wydawało — fundamenty, mury, całe pomieszczenia na wpół przykryte roślinnością. Cywilizacja Cyfrowa, jak mówią mieszkańcy osady, żyła z elektryczności i urządzeń, które trochę myślały za człowieka — skrzynek, płyt i ekranów w każdym kształcie, wplecionych we wszystko, co budowali. Większość z tego już nie działa, skorodowana do tego stopnia, że nie da się odróżnić jednej maszyny od drugiej. Pogrzeb trochę w ziemi i zobacz, co jeszcze skrywa. Miedziany drut byłby dobrym początkiem — każdy majsterkowicz w osadzie się ucieszy.
quest-craft-cord-name = Po nitce do kłębka
quest-craft-cord-description = W osadzie nikt już nie zawraca sobie głowy elektrycznością; dziś liczy się nić, węzeł, pole i kuźnia. Jest też jakaś stara nieufność wobec urządzeń w ruinach — coś w rodzaju niechęci do rzeczy, które kiedyś myślały za ludzi, choć nikt już nie pamięta dlaczego. A jednak trudno Ci przejść obojętnie obok tych cienkich, błyszczących płyt porozrzucanych wśród gruzu, gładkich jak spokojna woda pod warstwą brudu. Miedziany drut może kiedyś się przyda, ale to nie jest to czego potrzebujesz w tym momencie — kawałka porządnego, mocnego sznurka. Pnącze łatwo znaleźć — spróbuj połączyć kilka kawałków i zobacz, co otrzymasz. Czasem naprawdę, jak to mówią, po nitce do kłębka.
quest-craft-axe-name = Kłopoty na wschodzie
quest-craft-axe-description = Coś znów szykuje się na wschodzie. Od jakiegoś czasu było spokojnie, ale doświadczenie pokazuje, że kłopoty zawsze nadchodzą z tamtej strony. Starzy ludzie mają na to swoje historie — że pierwsi osadnicy musieli walczyć z samą ziemią, żeby przetrwać, że nawet rośliny jakby chciały się ich pozbyć. Niektórzy twierdzą, że dawny las umiał myśleć, planować, czekać. Bzdury, mówi większość, kręcąc głowami — rośliny nie intrygują. Ale jest w tych opowieściach coś, co daje Ci do myślenia. Cokolwiek się szykuje, lepiej się przygotuj! Idź do lasu, na łąkę i do jaskini, zbierz materiały, a potem poeksperymentuj z nimi i naucz się jak zrobić kamienną siekierę.
quest-disassemble-umbrella-name = Skarby ze złomu
quest-disassemble-umbrella-description = Stara, zepsuta parasolka wciąż ma w sobie dobre części — materiał, metalowy drążek, może coś więcej, jeśli przyjrzysz się bliżej. Ostatnio rozbierasz na części wszystko, co znajdziesz w ruinach, żeby zobaczyć, jak działały przedmioty z dawnych czasów. Stara technologia często chowa w sobie coś użytecznego, jeśli tylko zechcesz rozłożyć na części i trochę poeksperymentować. Gdzieś tam na pewno leży jedna taka parasolka, która czeka, żeby ją znaleźć.
