...
quest-old-civilization-description = Ruiny sięgają głębiej, niż się wydawało — fundamenty, mury, złom na wpół pochłonięty przez ziemię. Mieszkańcy osady nazywają to „Cywilizacją Cyfrową”, choć nikt nie jest do końca pewien, co to właściwie znaczy. Pogrzeb się w ziemi i zobacz, co jeszcze skrywa. Miedziany drut byłby dobrym początkiem — każdy majsterkowicz w osadzie się ucieszy.
